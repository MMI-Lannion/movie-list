...
export default function Movie({warning, bu, title, plot, orig_title, poster, director, oscar, cannes, berlin, mostra, cesar, year, runtime }) {
    ...
    return (<div className="bg-base-100 shadow-lg border border-slate-200 flex flex-col sm:flex-row items-center md:items-start justify-items-center grow-0 my-4 rounded-lg overflow-hidden">
